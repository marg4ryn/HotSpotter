<script setup lang="ts">
  ...
  const { t } = useI18n()
  const { showLabel, analysisTitle } = storeToRefs(useAppStore())
...
<template>
  <header class="app-bar">
    <div class="app-bar__left">
      ...
      <span class="app-name">{{ t('application.name') }}</span>
    </div>
    ...
    <div class="app-bar__right">
      ...
      <button class="icon-btn" aria-label="Profil użytkownika" @click="openProfile">
        <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
          <path
